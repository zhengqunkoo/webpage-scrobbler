...
const lastfmSharedSecret = '1a5d455bcffbd3eb5cb65d387cceb093'
...
const postApi = params => {
  params = Object.keys(params)
    ...
    .reduce(
      (obj, key) => {
        if (params[key] !== '') { // Exclude keys that have empty string value
          obj[key] = params[key]
        }
        return obj
      },
  ...
  params.api_sig = CryptoJS.MD5(Object.entries(params).map(e => e[0] + e[1]).join('') + lastfmSharedSecret).toString()
  console.log(params)

  return fetch('https://ws.audioscrobbler.com/2.0/', {method: 'post', body: new URLSearchParams(params)})
...
export {lastfmApiKey, postApi, validateXmlDoc}
